    ...
    <tr>
      <td valign="top" align="left">
        ...
        <a href="https://github.com/bsv-blockchain/go-bn/actions">
          <img src="https://img.shields.io/github/actions/workflow/status/bsv-blockchain/go-bn/run-tests.yml?branch=master&logo=github&style=flat" alt="Build Status">
        </a><br/>
		<a href="https://github.com/bsv-blockchain/go-bn/actions">
      ...
      <td valign="top" align="left">
		...
		<a href="https://codecov.io/gh/bsv-blockchain/go-bn">
...
All unit tests and [examples](examples) run via [GitHub Actions](https://github.com/bsv-blockchain/go-bn/actions) and use [Go version 1.24.x](https://go.dev/doc/go1.24). View the [configuration file](.github/workflows/run-tests.yml).
