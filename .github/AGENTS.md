...
**go-bn** is a Go package for Bitcoin Node interactions.
...
| `internals/` | Internal packages that are not exported but used within the project |
| `mocks/`     | Mock implementations for testing purposes                           |
| `models/`    | Data models and structures used across the project                  |
| `testing/`   | Testing utilities and helpers for writing tests                     |
| `zmq/`       | ZeroMQ related code, including client and server implementations    |
...
|------------|----------|-----------------------------------|
| 2025-07-09 | @mrz1836 | Adapted to fit this project go-bn |
